...
If you need to shift the menu panel towards the bottom or the left side, specify <a href="http://www.w3schools.com/css/css_padding.asp" target="_blank">padding</a> for the `<div>` that contains the widget. For example, the following code shifts the UI component towards the bottom.
