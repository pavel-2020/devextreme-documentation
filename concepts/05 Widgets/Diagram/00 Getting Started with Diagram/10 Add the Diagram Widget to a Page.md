...
The Diagram UI component is a jQuery DevExtreme widget. Common DevExtreme resources (listed below) should be included in your page after the Diagram resources.
