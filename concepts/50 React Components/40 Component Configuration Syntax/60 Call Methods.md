...
Alternatively, you can save the UI component instance in a component property once the UI component is initialized. This approach is not compatible with <a href="https://reactjs.org/docs/hooks-intro.html" target="_blank">React Hooks</a>.
