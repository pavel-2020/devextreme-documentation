Templates allow you to customize UI component elements. DevExtreme templates make use of the <a href="https://vuejs.org/v2/guide/components-slots.html#Named-Slots" target="_blank">named slots</a> functionality provided by Vue.
