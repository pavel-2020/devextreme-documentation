Icons in UI components are inserted into the DOM as `<i>` elements. When you set a widget's **icon** option, its value is used to form the `class` attribute of the `<i>` element. For instance, the code below ...
