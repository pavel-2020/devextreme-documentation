...
Set the **format** UI component option to apply a predefined format. In the following code, this option specifies the format and precision of the tooltip's value in the **Slider** widget. The value contains two decimal digits when the precision value is 2.
