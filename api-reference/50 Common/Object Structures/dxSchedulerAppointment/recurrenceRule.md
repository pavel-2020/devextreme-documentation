...
If your existent data source objects use a custom name for recurrence field, specify it in the [recurrenceRuleExpr](/Documentation/ApiReference/UI_Components/dxScheduler/Configuration/#recurrenceRuleExpr) property.
