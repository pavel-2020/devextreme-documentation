...
- *"selectAll"*       
The UI component displays one checkbox per item and one "Select All" checkbox at the top of the widget. The [selectionMode](/api-reference/10%20UI%20Widgets/dxTreeView/1%20Configuration/selectionMode.md '/Documentation/ApiReference/UI_Widgets/dxTreeView/Configuration/#selectionMode') should be *"multiple"*.
